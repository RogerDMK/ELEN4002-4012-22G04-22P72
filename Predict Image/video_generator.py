...
class VideoGenerator():
    ...
    def save_image(self, img, title):
        ...
        ax = fig.add_subplot()
        imag = ax.imshow(img, interpolation='nearest', cmap='plasma', vmin=0, vmax=1)
    ...
    def create_video(self, name):
        ...
        video_file = os.path.join(self.base_path, "{}.gif".format(name))
        # anim.save(video_file)
        anim.save(video_file, writer=animation.PillowWriter(fps=1))
